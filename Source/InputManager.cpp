...
bool InputManager::IsKeyDown(Keys aKey) const
{
    const std::map<Keys, bool>::const_iterator iterator = myKeys.find(aKey);
...
bool InputManager::IsMouseButtonDown(MouseButtons aMouseButton) const
{
    const std::map<MouseButtons, bool>::const_iterator iterator = myMouseButtons.find(aMouseButton);
...
Keys InputManager::GetTranslatedKey(int aKey)
{
    switch (aKey)
    {
        case GLFW_KEY_SPACE:
...
MouseButtons InputManager::GetTranslatedMouseButton(int aButton)
{
    switch (aButton)
    {
